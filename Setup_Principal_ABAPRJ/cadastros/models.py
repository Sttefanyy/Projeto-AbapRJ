        ...
        if self.opcao == "Func":
            ...
            try:
                ...
                raise ValidationError(
                    "Cadastro de Funcionário não encontrado ou e-e-mail/senha incorretos."
                )
        else:
            ...
            try:
                ...
                raise ValidationError("E-e-mail ou senha incorretos para Admin.")
...
class Admin(models.Model):
    situacao = (("Adm.", "administração "), ("Gte.", "Gerente"))
    ...
    cod_acesso = models.CharField(
        null=True, max_length=15, default="", verbose_name="codigo de acesso"
    )
...
class MembroFamilia(models.Model):
    sexo_tipo = (("M", "Masculino"), ("F", "Feminino"))
    situacao = (("Ativo.", "Atuante "), ("Inativo", "Ausente"))
...
class EsqueciSenha(models.Model):
    ...
    def verificar_email(self):
        voluntario = CadastroVoluntario.objects.filter(email=self.email).first()
        ...
        if voluntario:
            ...
            raise ValidationError("E-e-mail não encontrado.")
